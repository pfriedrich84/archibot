...
- ArchiBot is intentionally local-first: Paperless-NGX, Ollama/OpenAI-compatible local providers, PostgreSQL, and Docker are the core operational assumptions.
