...
- Pinned Python transitive constraints in `constraints.txt`, including PostgreSQL/pgvector runtime dependencies and any temporary migration-only queue dependencies.
...
- This policy applies especially to Laravel/Svelte/Inertia, Laravel queue-related dependencies, Python libraries such as httpx/SQLAlchemy, Docker/Compose, Paperless APIs, and OpenAI-compatible provider payloads.
