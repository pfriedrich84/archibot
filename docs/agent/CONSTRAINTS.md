...
- LLM classification, embeddings, OCR correction, and judge behavior are designed around local Ollama or OpenAI-compatible provider models. Chat/RAG is disabled pending Issue #221.
