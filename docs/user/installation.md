...
cp .env.example .env
# → Docker-/Ollama-Werte eintragen; Paperless-Verbindung wird im Setup-Wizard konfiguriert
...
4. **Admin-Settings** — Ollama, Inbox-Tag, Klassifikation, Review, Worker, MCP und Audit-Retention werden in `/admin/settings` gepflegt
