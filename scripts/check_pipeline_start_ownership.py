...
LIFECYCLE_SAFE_LITERAL_METHODS = {
    ...
    "laravel/app/Jobs/RunPythonActorJob.php": {
        "consumecommand",
        "consumeentirecommand",
        "dispatchforpollcommand",
        "findorfail",
        "fresh",
        "isfuture",
        "issue",
    ...
    "laravel/app/Services/Pipeline/PipelineRecoveryDispatcher.php": {
        ...
        "reconcilecompletedpollcommands",
        ...
        "releasetemporalembeddingblockedruns",
        "replaypending",
        "pluck",
